{ lib, crane, rustToolchain, fetchpatch, clang, cmake, copyDesktopItems, curl
, perl, pkg-config, protobuf, fontconfig, freetype, libgit2, openssl, sqlite
, zlib, zstd, alsa-lib, libxkbcommon, wayland, swift, libglvnd, xorg, stdenv
, makeFontsConf, vulkan-loader, envsubst, cargo-about, cargo-bundle, git
, apple-sdk_15, darwinMinVersionHook, makeWrapper, nodejs_22, nix-gitignore,
...
let
  includeFilter = path: type:
    ...
    in !(inRootDir && (baseName == "docs" || baseName == ".github" || baseName
      == ".git" || baseName == "target"));
  ...
  commonArgs = rec {
    ...
    nativeBuildInputs =
      [ clang cmake copyDesktopItems curl perl pkg-config protobuf cargo-about ]
    ...
    env = {
      ...
      FONTCONFIG_FILE = makeFontsConf {
        fontDirectories =
          [ "${src}/assets/fonts/plex-mono" "${src}/assets/fonts/plex-sans" ];
      };
...
in craneLib.buildPackage (commonArgs // rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://raw.githubusercontent.com/NixOS/nixpkgs/1fd02d90c6c097f91349df35da62d36c19359ba7/pkgs/by-name/ze/zed-editor/0001-generate-licenses.patch";
    ...
    (fetchpatch {
      url =
        "https://raw.githubusercontent.com/NixOS/nixpkgs/1fd02d90c6c097f91349df35da62d36c19359ba7/pkgs/by-name/ze/zed-editor/0002-disable-livekit-darwin.patch";
      hash = "sha256-whZ7RaXv8hrVzWAveU3qiBnZSrvGNEHTuyNhxgMIo5w=";
    })
  ];

  cargoExtraArgs =
    "--package=zed --package=cli --features=gpui/runtime_shaders";
